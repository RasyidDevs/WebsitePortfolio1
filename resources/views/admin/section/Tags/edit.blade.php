        ...
        <div class="d-flex" id="wrapper">
           ...
           @include('admin/component/sidebar')
            ...
            <div id="page-content-wrapper">
                ...
                <!-- Page content-->
                <div class="container">
                    <form method="POST" action="{{ url("admin/dashboard/tags/update/$data->id") }}" >
                       @csrf
                        <div class="mb-3 mt-3">
                            <label for="exampleInputPassword1" class="form-label">Tag_name</label>
                            <input type="text" class="form-control" id="exampleInputPassword1" name="tag" value="{{ $data->tag_name }}">
                        </div>
                        <button type="submit" class="btn btn-primary">Edit</button>
                        <button type="reset" class="btn btn-danger"><a href="{{ url("admin/dashboard/tags") }}" class="btn-save">Reset</a></button>
                    </form>
                    @if ($errors->any())
