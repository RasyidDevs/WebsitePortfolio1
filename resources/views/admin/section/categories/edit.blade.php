        ...
        <div class="d-flex" id="wrapper">
           ...
           @include('admin/component/sidebar')
            ...
            <div id="page-content-wrapper">
                ...
                <div class="container">
                  <div class="form">
                    <form method="POST" action="{{ url('admin/dashboard/categories/update/'.$data->id)  }}">
                      @csrf
                      <div class="mb-3 mt-3">
                        <label for="exampleInputPassword1" class="form-label">Category</label>
                        <input type="text" class="form-control" id="exampleInputPassword1" name="category" value="{{ $data->category_name }}">
                      </div>
                      <div class="mb-3">
                        <label for="exampleInputPassword1" class="form-label">Icon</label>
                        <input type="text" class="form-control" id="exampleInputPassword1" name="icon" value="{{ $data->icon }}" >
                      </div>
                      <button type="submit" class="btn btn-primary">Edit</button>
                      <button type="submit" class="btn btn-danger"><a href="{{ url("admin/dashboard/categories") }}" class="btn-save">Reset</a></button>
                  </form>
                  </div>
