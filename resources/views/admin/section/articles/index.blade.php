        ...
        <div class="d-flex" id="wrapper">
           ...
           @include('admin/component/sidebar')
            ...
            <div id="page-content-wrapper">
                ...
                <!-- Page content-->
                <div class="container">
                    <form method="POST" action="{{ url("admin/dashboard/articles/store") }}"  enctype="multipart/form-data">
                       @csrf
                        <div class="mb-3 mt-3">
                            <label for="exampleInputPassword1" class="form-label">categories_id</label>
                            <input type="text" class="form-control" id="exampleInputPassword1" name="categories">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label>News</label>
                            <textarea class="form-control" rows="5" name="news"></textarea>
                        </div>
